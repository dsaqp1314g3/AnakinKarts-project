insert into users (userpass,email, username, name, phone, ciudad, calle, numero, piso,puerta, cp) values ('david', 'david@anakinkarts.com','david', 'david','664567234','Barcelona','Muntaner','170','1','2','08021');
insert into users (userpass,email, username, name, phone, ciudad, calle, numero, piso,puerta, cp) values ('ivan','ivan@anakinkarts.com','ivan', 'ivan','648967732','Barcelona','Urgell','55','3','1','08034');
insert into users (userpass,email, username, name, phone, ciudad, calle, numero, piso,puerta, cp) values ('edith','edith@anakinkarts.com','edith', 'edith','602484218','Barcelona','Provença','270','2','2','08032');
insert into users (userpass,email, username, name, phone, ciudad, calle, numero, piso,puerta, cp) values ('pepito','pepito@anakinkarts.com','pepito', 'pepito','648456432','Castelldefels','diagonal','12','5','1','08860');
