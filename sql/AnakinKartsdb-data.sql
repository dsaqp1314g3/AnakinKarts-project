...
insert into users (userpass,email, username, name, phone, ciudad, calle, numero, piso,puerta, cp) values ('pepito','pepito@anakinkarts.com','pepito', 'pepito camelas','648456432','Castelldefels','diagonal','12','5','1','08860');

insert into evento (organizador,participantes,fecha,pista,ganador,mejorvuelta,fotos) values ('edith', 3,'2014-05-02', 1,'david','134','http://10.189.135.123/imgs/weah');
insert into evento (organizador,participantes,fecha,pista,ganador,mejorvuelta,fotos) values ('ivan', 2,'2014-01-12', 1,'ivan','135','http://10.189.135.123/imgs/weah2');
insert into evento (organizador,participantes,fecha,pista,ganador,mejorvuelta,fotos) values ('ivan', 2,'2014-03-29', 2,'edith','164','http://10.189.135.123/imgs/weah3');
