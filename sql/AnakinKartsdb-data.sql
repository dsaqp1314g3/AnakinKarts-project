...
insert into relacion(username,nombreevento,eventoid,invitacion) values ('david','Cumple Ana', 1,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('edith','Cumple Ana', 1,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('ivan','Cumple Ana', 1,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('edith','Racing', 2,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('ivan','Racing', 2,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('edith','Despedida Ivan', 3,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('ivan','Despedida Ivan', 3,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('david','David Wise DJ' 4,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('edith','David Wise DJ' 4,'aceptada');
insert into relacion(username,nombreevento, eventoid,invitacion) values ('benito','David Wise DJ' 4,'esperando');
