...
public class UserResource {
	...
	private DataSource dsU = DataSourceUsers.getInstance().getDataSource();
	...
	public User updateProfile(@PathParam("username") String username, User user){
		...
		/*Peta aquí*/System.out.println(" Nombre de la cabecera de seguridad: "+ security.getUserPrincipal().getName()+ " username cogido del path");
